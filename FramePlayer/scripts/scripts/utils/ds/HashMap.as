package utils.ds
{
   ...
   public class HashMap implements ICollection
   {
      ...
      public function getValues() : Array
      {
         ...
         var _loc2_:Array = new Array(_length);
         var _loc1_:int = 0;
      ...
      public function clone() : HashMap
      {
         ...
         var _loc2_:HashMap = new HashMap(_weakKeys);
         for(_loc1_ in _content)
         {
            _loc2_.add(_loc1_,_content[_loc1_]);
         }
         return _loc2_;
      }
      ...
      public function toString() : String
      {
         ...
         while(_loc1_ < _loc5_)
         {
            _loc4_ += _loc3_[_loc1_] + " -> " + _loc2_[_loc1_] + "\n";
            _loc1_++;
         }
         return _loc4_;
      }
      ...
      public function filter(param1:Function) : Array
      {
         ...
         var _loc3_:* = undefined;
         var _loc2_:Array = [];
         for(_loc4_ in _content)
         {
            _loc3_ = _content[_loc4_];
